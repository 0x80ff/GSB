...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr" lang="fr">
	...
	<body onload="setTimeout(hideNotify,7000);">
		<div id="page">
			<div id="entete">
				<img src="<?php echo $v_path.'/images/logo.png'?>" id="logoGSB" alt="Laboratoire Galaxy-Swiss Bourdin" title="Laboratoire Galaxy-Swiss Bourdin" />
			...
			<div id="menuGauche">
				...
				<ul id="menuList">
					...
					<li class="smenu">
						<?php echo anchor('c_comptable/gesFiches', 'Validation fiches de frais', 'title="Consultation des fiches de frais"'); ?>
					<br/>
					<li class="smenu">
						<?php echo anchor('c_comptable/gesPaiement', 'Mise en paiement des fiches de frais', 'title="Consultation des paiement des fiches de frais"'); ?>
					<br/>
					</li>
					</li>
